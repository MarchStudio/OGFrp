...
copy src\OGFrp.Linux\frpc\frpc_linux_i386 .\OGFrp.Linux.Pack\frpc\i386
copy src\OGFrp.Linux\frpc\frpc_linux_amd64 .\OGFrp.Linux.Pack\frpc\amd64
copy src\OGFrp.Linux\frpc\frpc_linux_arm64 .\OGFrp.Linux.Pack\frpc\arm64
copy src\OGFrp.Linux\frpc\frpc_linux_arm .\OGFrp.Linux.Pack\frpc\arm
